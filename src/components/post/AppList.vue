  ...
  <div class="app-list">
    <ul class="app-list__container">
      <li v-for="postItem in currentPosts" v-bind:key="postItem" class="list-item">
        <router-link class="list-item__thumnail" :to="{name: 'ViewPage', params: { posttitle : postItem.title, postdate : postItem.date, postURL : postItem.url }}">
        ...
        <router-link class="list-item__title" :to="{name: 'ViewPage', params: { posttitle : postItem.title, postdate : postItem.date, postURL : postItem.url }}">
          {{ postItem.title }}
        </router-link>
